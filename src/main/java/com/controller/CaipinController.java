...
public class CaipinController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,CaipinEntity caipin, HttpServletRequest request){
		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("shangjia")) {
			caipin.setShangjiabianhao((String)request.getSession().getAttribute("username"));
		}
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,CaipinEntity caipin, HttpServletRequest request){
        EntityWrapper<CaipinEntity> ew = new EntityWrapper<CaipinEntity>();
		PageUtils page = caipinService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, caipin), params), params));
        return R.ok().put("data", page);
    }
